...
#include OrdinalGet.ahk

Date(date) {

fdate := DateParse(date)                                 ;- convert date to YYYYMMDDHH24MISS format
...

{
                ...
                if (StrLen(fdate) == 6){
                                ...
                                FormatTime, fdate, %fdate%, MMMM yyyy
                                ...
                                FormatTime, fdate, %fdate%, d MMMM yyyy

 

                                blankdate = 0

                                fblankdate := DateParse(blankdate)

                                FormatTime, fblankdate, %fblankdate%, d MMMM yyyy
