...
public class AutomateYourJobUI extends javax.swing.JFrame {
     ...
     * @return 
     */
    static ArrayList<String> fileRead() {
    ...
    private void initComponents() {
        ...
        jMainText.setText(fileRead().get(0));
        ...
        jPositionText.setText(fileRead().get(2));
        ...
        jSalaryText.setText(fileRead().get(3));
        ...
        jInfoText.setRows(5);
        jInfoText.setText(fileRead().get(4));
    ...
    private void jDefaultButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jDefaultButtonActionPerformed
            jMainText.setText("advised that the Candidate was employed from");
            jTo.setText("to");
    ...
    private void jLoadButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jLoadButtonActionPerformed
            ...
            // fileRead() defined on 46. returns array of the read template.
            String main = fileRead().get(0);
            String to = fileRead().get(1);
            String position = fileRead().get(2);
            String salary = fileRead().get(3);
            String info = fileRead().get(4);
            jMainText.setText(main);
            jTo.setText(to);
            jPositionText.setText(position);
            jSalaryText.setText(salary);
            jInfoText.setText(info);
